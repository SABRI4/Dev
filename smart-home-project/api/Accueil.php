        ...
        <nav>
            <ul>
                ...
                if (isset($_SESSION['user_id'])) {
                    ...
                    if ($_SESSION['VIP'] == 1) {
                        echo '<li><a href="ModuleSpécial.php">Graphiques</a></li>';
                    }
                    echo '<li><a href="Module1.php">Centre d aide</a></li>';
                    echo '<li><a href="Module2.php">Modifier Profil</a></li>';
                    echo '<li><a href="Module3.php">Déconnexion</a></li>';
